...
\begin{minipage}[b]{0.3\textwidth}
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[dotted,name path=F, line width=0.3mm, color=blue, domain={0:12}, samples=100]
            ...
            \addplot[dotted, name path=G, line width=0.3mm, color=red, domain={0:12}, samples=100]
                {(pow(2,-1*pow(x-5.5,2)))};
        \end{axis}
    \end{tikzpicture}
\end{minipage}
...
\begin{minipage}[b]{0.3\textwidth}
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[name path=F, line width=0.3mm, color=red, domain={5:12}, samples=100]
                {(pow(2,-1*pow(x-9,2)))};
            ...
            \addplot[name path=G, line width=0.3mm, color=blue, domain={0:5}, samples=100]
                {(2*pow(2,-1*pow(x-2,2)))};
        \end{axis}
    \end{tikzpicture}
\end{minipage}
